...
var World = {
	...
	// POI-Marker asset スタンプの画像
	markerDrawable_stamp_red: null,
	...
	loadPoisFromJsonData: function loadPoisFromJsonDataFn(poiData) {
		...
		*/
		// 画像
		World.markerDrawable_stamp_red = new AR.ImageResource("assets/stamp_red.png");
		...
		*/
		...
		// 描画情報.８は８倍のサイズ
		var markerImageDrawable_stamp_red = new AR.ImageDrawable(World.markerDrawable_stamp_red, 8, {
			zOrder: 0,  // 表示順
			opacity: 1.0,   // 不透明
			// クリック時処理
			onClick : function() {
    	...
    	var elevatorAnimation = new AR.PropertyAnimation(
              markerImageDrawable_stamp_red, //the object geoLocation1 holds the animated property
		...
		var markerObject = new AR.GeoObject(markerLocation, {
			drawables: {
				cam: [markerImageDrawable_stamp_red]
			}
		});
