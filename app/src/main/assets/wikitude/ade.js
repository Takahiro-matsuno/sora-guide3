...
if (!AR.build.mobile) {
    ...
    AR.__resourceUrl = function(a) {
        ...
        var d = document.baseURI.substring(0, document.baseURI.indexOf("/") +
            2);
        var c = document.baseURI.substring(document.baseURI.indexOf("/") +
            2);
    ...
    AR.VALIDATE = {
        ...
        isHex: function(b) {
            if (typeof b != "string" || !AR.VALIDATE.isDefined(b) || b.charAt(
                    0) != "#") {
                return false
            }
            var c = b.length;
        ...
        create: function(d, b, e, a) {
            ...
            switch (b) {
                case AR.ERROR.TYPE.UNDEFINED:
                    c = AR.ERROR.ERROR_PREFIX + d + " is undefined" +
                        buildStack("<br />");
                    break;
                case AR.ERROR.TYPE.INVALID_VALUE:
                    c = AR.ERROR.ERROR_PREFIX + d + " is invalid" +
                        buildStack("<br />");
                    break;
                case AR.ERROR.TYPE.RANGE:
                    c = AR.ERROR.ERROR_PREFIX + d +
                        " is not in the valid range " + e + buildStack(
                            "<br />");
                    break;
                case AR.ERROR.TYPE.ENUMERATION:
                    c = AR.ERROR.ERROR_PREFIX + d +
                        " is not one of the allowed values defined in the 'enumeration-object' " +
                        e + buildStack("<br />");
                    break;
                case AR.ERROR.TYPE.FLOAT:
                    c = AR.ERROR.ERROR_PREFIX + d +
                        " is not a numeric value." + buildStack(
                            "<br />");
                    break;
                case AR.ERROR.TYPE.INT:
                    c = AR.ERROR.ERROR_PREFIX + d +
                        " is not a whole number." + buildStack("<br />");
                    break;
                case AR.ERROR.TYPE.BOOLEAN:
                    c = AR.ERROR.ERROR_PREFIX + d +
                        " is not a boolean value." + buildStack(
                            "<br />");
                    break;
                case AR.ERROR.TYPE.ARRAY_CONTENT:
                    c = AR.ERROR.ERROR_PREFIX + d +
                        " contains invalid values in the array." +
                        buildStack("<br />");
                    break;
                case AR.ERROR.TYPE.OBJECT:
                    c = AR.ERROR.ERROR_PREFIX + d + " of object type " +
                        a + " is not of the expected object type " + e +
                        buildStack("<br />");
                    break;
                case AR.ERROR.TYPE.IMMUTABLE:
                    c = AR.ERROR.ERROR_PREFIX + d +
                        " must not be altered." + buildStack("<br />");
                    break;
                case AR.ERROR.TYPE.HEX:
                    c = AR.ERROR.ERROR_PREFIX + d +
                        " is not a valid hex value." + buildStack(
                            "<br />");
                    break;
                case AR.ERROR.TYPE.UNKNOWN_PROPERTY:
                    c = AR.ERROR.ERROR_PREFIX + "Property " + d +
                        " cannot be found." + buildStack("<br />");
                    break;
                case AR.ERROR.TYPE.STRING:
                    c = AR.ERROR.ERROR_PREFIX + d +
                        " is not a String value." + buildStack("<br />");
                    break
            }
            AR.logger.error(c);
            return c
                    ...
                    switch (d.type) {
                        case _PROPERTY_VALIDATOR.TYPE.FUNCTION:
                            if (typeof h == "function") {
                                ...
                                throw AR.ERROR.create(a, AR.ERROR.TYPE.OBJECT,
                                    "function", typeof h)
                            }
                            break;
                        ...
                        case _PROPERTY_VALIDATOR.TYPE.UNIT_INTERVAL:
                            h = _PROPERTY_VALIDATOR.validate(a, h,
                                _PROPERTY_VALIDATOR.TYPE.NUMERIC, g,
                                c);
                            if (h < 0 || h > 1) {
                                throw AR.ERROR.create(a, AR.ERROR.TYPE.RANGE,
                                    "[0, 1]")
                            } else {
                                break
                            }
                        ...
                        case _PROPERTY_VALIDATOR.TYPE.POSITIVE_INT:
                            h = _PROPERTY_VALIDATOR.validate(a, h,
                                _PROPERTY_VALIDATOR.TYPE.INT, g, c);
                            if (h <= 0) {
                                throw AR.ERROR.create(a, AR.ERROR.TYPE.RANGE,
                                    "(0, infinity)")
                            }
                        ...
                        case _PROPERTY_VALIDATOR.TYPE.INT:
                            if (typeof h != "number") {
                                ...
                                if (Math.round(h) != h) {
                                    throw AR.ERROR.create(a, AR.ERROR.TYPE
                                        .INT)
                                }
                            }
                            break;
    ...
    AR.om = {
        ...
        getExistingObjectForID: function getObjectForID(b) {
            ...
            if (a) {
                ...
                throw "Object with ID " + b +
                    " does not exist - maybe it was already destroyed?"
            }
        },
    ...
    AR.js.clickBehavior = {
        clickEvent: function(c) {
            for (var b = 0; b < AR.js.clickbuster.coordinates.length; b +=
                2) {
                var a = AR.js.clickbuster.coordinates[b];
                var d = AR.js.clickbuster.coordinates[b + 1];
                if (Math.abs(c.clientX - a) < 25 && Math.abs(c.clientY -
                        d) < 25) {
                    c.stopPropagation();
                    c.preventDefault()
                }
        ...
        executeClick: function(a) {
            if (a.target === document.body || a.target === document.documentElement ||
                (a.target.style.background == "none" && typeof(a.target
                        .attributes["data-role"]) !== "undefined" && a.target
                    .attributes["data-role"].value === "page")) {
    ...
    AR.js.clickBehavior.removeClickBehavior = function() {
        if (AR.js.clickBehavior.currentBehavior != null) {
            if (AR.js.clickBehavior.currentBehavior.touchstartEvent != null) {
                document.removeEventListener("touchstart", AR.js.clickBehavior
                    .currentBehavior.touchstartEvent, true)
            }
            if (AR.js.clickBehavior.currentBehavior.touchmoveEvent != null) {
                document.removeEventListener("touchmove", AR.js.clickBehavior
                    .currentBehavior.touchmoveEvent, true)
            }
            if (AR.js.clickBehavior.currentBehavior.touchendEvent != null) {
                document.removeEventListener("touchend", AR.js.clickBehavior
                    .currentBehavior.touchendEvent, true)
            }
    ...
    AR.js.clickBehavior.addClickBehavior = function(a) {
        ...
        AR.js.clickBehavior.clickEvent = document.addEventListener("click",
            AR.js.clickBehavior.clickEvent, true)
    };
    ...
    AR.ARchitectObject = PClass.create({
        init: function() {
            ...
            this.__defineSetter__("destroyed", function(c) {
                throw AR.ERROR.create("destroyed", AR.ERROR
                    .TYPE.IMMUTABLE)
            });
        ...
        init: function(d) {
            ...
            if (d) {
                if (d.enabled != undefined) {
                    a = _PROPERTY_VALIDATOR.validate("enabled", d.enabled,
                        _PROPERTY_VALIDATOR.TYPE.BOOLEAN,
                        _PROPERTY_VALIDATOR.RULE.MUST_BE_SET)
                }
                if (d.triggers) {
                    if (d.triggers.onEnterFieldOfVision) {
                        c = _PROPERTY_VALIDATOR.validate(
                            "triggers.onEnterFieldOfVision", d.triggers
                            .onEnterFieldOfVision,
                            _PROPERTY_VALIDATOR.TYPE.FUNCTION,
                            _PROPERTY_VALIDATOR.RULE.CAN_BE_EMPTY
                        )
                    }
                    if (d.triggers.onExitFieldOfVision) {
                        g = _PROPERTY_VALIDATOR.validate(
                            "triggers.onExitFieldOfVision", d.triggers
                            .onExitFieldOfVision,
                            _PROPERTY_VALIDATOR.TYPE.FUNCTION,
                            _PROPERTY_VALIDATOR.RULE.CAN_BE_EMPTY
                        )
                ...
                if (d.onEnterFieldOfVision) {
                    c = _PROPERTY_VALIDATOR.validate(
                        "onEnterFieldOfVision", d.onEnterFieldOfVision,
                        _PROPERTY_VALIDATOR.TYPE.FUNCTION,
                        _PROPERTY_VALIDATOR.RULE.CAN_BE_EMPTY)
                }
                if (d.onExitFieldOfVision) {
                    g = _PROPERTY_VALIDATOR.validate(
                        "onExitFieldOfVision", d.onExitFieldOfVision,
                        _PROPERTY_VALIDATOR.TYPE.FUNCTION,
                        _PROPERTY_VALIDATOR.RULE.CAN_BE_EMPTY)
                }
                if (d.onClick) {
                    e = _PROPERTY_VALIDATOR.validate("onClick", d.onClick,
                        _PROPERTY_VALIDATOR.TYPE.FUNCTION,
                        _PROPERTY_VALIDATOR.RULE.CAN_BE_EMPTY)
                }
                b = new AR.ARObjectDrawables(this, d.drawables);
                if (d.renderingOrder) {
                    f = _PROPERTY_VALIDATOR.validate(
                        "renderingOrder", d.renderingOrder,
                        _PROPERTY_VALIDATOR.TYPE.NUMERIC,
                        _PROPERTY_VALIDATOR.RULE.MUST_BE_SET)
                }
            } else {
            ...
            this.__defineSetter__("drawables", function(h) {
                throw AR.ERROR.create("drawables", AR.ERROR
                    .TYPE.IMMUTABLE)
            });
            ...
            this.__defineSetter__("enabled", function(h) {
                h = _PROPERTY_VALIDATOR.validate("enabled",
                    h, _PROPERTY_VALIDATOR.TYPE.BOOLEAN,
                    _PROPERTY_VALIDATOR.RULE.MUST_BE_SET
                );
                AR.i.callAsync({
                    objectId: this.__id,
            ...
            this.__defineSetter__("renderingOrder", function(h) {
                h = _PROPERTY_VALIDATOR.validate(
                    "renderingOrder", h,
                    _PROPERTY_VALIDATOR.TYPE.NUMERIC,
                    _PROPERTY_VALIDATOR.RULE.MUST_BE_SET
                );
            ...
            this.__defineSetter__("onEnterFieldOfVision", function(
                h) {
                h = _PROPERTY_VALIDATOR.validate(
                    "onEnterFieldOfVision", h,
                    _PROPERTY_VALIDATOR.TYPE.FUNCTION,
                    _PROPERTY_VALIDATOR.RULE.CAN_BE_EMPTY
                );
                c = h;
                AR.i.callAsync({
                    objectId: this.__id,
                    onEnterFieldOfVisionTriggerActive: h !=
                        null,
            ...
            this.__defineSetter__("__onEnterFieldOfVision__",
                function(h) {});
            this.__defineGetter__("__onEnterFieldOfVision__",
                function() {
                    var h = null;
                    if (c) {
                        if (this._triggers) {
                            h = this.onEnterFieldOfVision.call(
                                this._triggers)
                        } else {
            ...
            this.__defineSetter__("onExitFieldOfVision", function(h) {
                ...
                AR.i.callAsync({
                    objectId: this.__id,
                    onExitFieldOfVisionTriggerActive: h !=
                        null,
            ...
            this.__defineSetter__("__onExitFieldOfVision__",
                function(h) {});
            this.__defineGetter__("__onExitFieldOfVision__",
                function() {
                    var h = null;
                    if (g) {
                        if (this._triggers) {
            ...
            this.__defineSetter__("onClick", function(h) {
                h = _PROPERTY_VALIDATOR.validate("onClick",
                    h, _PROPERTY_VALIDATOR.TYPE.FUNCTION,
                    _PROPERTY_VALIDATOR.RULE.CAN_BE_EMPTY
                );
                e = h;
                AR.i.callAsync({
    ...
    AR.ARObjectDrawables = PClass.create({
        init: function(a, g) {
            ...
            if (g != null) {
                ...
                if (g.radar) {
                    d = _PROPERTY_VALIDATOR.validate(
                        "drawables.radar", g.radar, {
                            type: _PROPERTY_VALIDATOR.TYPE.ARRAY_OR_PROPERTY,
                ...
                if (g.indicator) {
                    c = _PROPERTY_VALIDATOR.validate(
                        "drawables.indicator", g.indicator, {
                            type: _PROPERTY_VALIDATOR.TYPE.ARRAY_OR_PROPERTY,
                            ofType: AR.Drawable2D
                        }, _PROPERTY_VALIDATOR.RULE.CAN_BE_EMPTY
                    )
            ...
            this.__defineSetter__("cam", function(i) {
                i = _PROPERTY_VALIDATOR.validate(
                    "drawables.cam", i, {
                        type: _PROPERTY_VALIDATOR.TYPE.ARRAY_OR_PROPERTY,
                        ofType: AR.Drawable
                    }, _PROPERTY_VALIDATOR.RULE.CAN_BE_EMPTY
                ...
                AR.i.callAsync({
                    objectId: a.__id,
                    camDrawableIds: AR.__toJSONString__(
                        AR.om.__getIds__(i)),
            ...
            this.__defineSetter__("radar", function(i) {
                if (a instanceof AR.GeoObject) {
                    ...
                    AR.i.callAsync({
                        objectId: a.__id,
                        radarDrawableIds: AR.__toJSONString__(
                            AR.om.__getIds__(i)
                        ),
            ...
            this.__defineSetter__("indicator", function(i) {
                if (a instanceof AR.GeoObject) {
                    ...
                    AR.i.callAsync({
                        objectId: a.__id,
                        indicatorDrawableIds: AR.__toJSONString__(
                            AR.om.__getIds__(i)
                        ),
            ...
            var b = function(p, m, k, o) {
                ...
                if (!k) {
                    ...
                    if (!AR.VALIDATE.isWholeNumber(k)) {
                        throw AR.ERROR.create("position", AR.ERROR
                            .TYPE.INT)
                    }
                    if (!AR.VALIDATE.isNonNegative(k)) {
                        throw AR.ERROR.create("position", AR.ERROR
                            .TYPE.RANGE, "[0, Infinity)")
                    }
                }
                if (k < 0) {
    ...
    AR.Drawable = AR.ARchitectObject.extend({
        init: function(b) {
            ...
            var d = null;
            if (b) {
                a = _PROPERTY_VALIDATOR.validate("enabled", b.enabled,
                    _PROPERTY_VALIDATOR.TYPE.BOOLEAN,
                    _PROPERTY_VALIDATOR.RULE.CAN_BE_EMPTY);
                if (a == null) {
                    a = true
                ...
                if (b.triggers) {
                    c = _PROPERTY_VALIDATOR.validate("onClick", b.triggers
                        .onClick, _PROPERTY_VALIDATOR.TYPE.FUNCTION,
                        _PROPERTY_VALIDATOR.RULE.CAN_BE_EMPTY)
                }
                if (b.onClick) {
                    c = _PROPERTY_VALIDATOR.validate("onClick", b.onClick,
                        _PROPERTY_VALIDATOR.TYPE.FUNCTION,
                        _PROPERTY_VALIDATOR.RULE.CAN_BE_EMPTY)
                }
            }
            ...
            this.__defineSetter__("enabled", function(e) {
                e = _PROPERTY_VALIDATOR.validate("enabled",
                    e, _PROPERTY_VALIDATOR.TYPE.BOOLEAN,
                    _PROPERTY_VALIDATOR.RULE.CAN_BE_EMPTY
                );
                if (e == null) {
                    e = true
            ...
            this.__defineSetter__("onClick", function(e) {
                e = _PROPERTY_VALIDATOR.validate("onClick",
                    e, _PROPERTY_VALIDATOR.TYPE.FUNCTION,
                    _PROPERTY_VALIDATOR.RULE.CAN_BE_EMPTY
                );
                c = e;
                AR.i.callAsync({
    ...
    AR.DrawableRotate = PClass.create({
        init: function(d, c) {
            ...
            if (c && (typeof c != "object")) {
                throw AR.ERROR.create("rotate", AR.ERROR.TYPE.OBJECT,
                    "rotate")
            }
            if (c) {
                if (c.roll) {
                    b = _PROPERTY_VALIDATOR.validate("rotate.roll",
                        c.roll, _PROPERTY_VALIDATOR.TYPE.NUMERIC,
                        _PROPERTY_VALIDATOR.RULE.MUST_BE_SET)
                }
                if (c.tilt) {
                    a = _PROPERTY_VALIDATOR.validate("rotate.tilt",
                        c.tilt, _PROPERTY_VALIDATOR.TYPE.NUMERIC,
                        _PROPERTY_VALIDATOR.RULE.MUST_BE_SET)
                }
                if (c.heading) {
                    e = _PROPERTY_VALIDATOR.validate(
                        "rotate.heading", c.heading,
                        _PROPERTY_VALIDATOR.TYPE.NUMERIC,
                        _PROPERTY_VALIDATOR.RULE.MUST_BE_SET)
                }
            }
    ...
    AR.Drawable2D = AR.Drawable.extend({
        validateHorizontalAnchor: function(a) {
            if (!AR.CONST.HORIZONTAL_ANCHOR.isValidHorizontalAnchor(
                    a)) {
                throw AR.ERROR.create("horizontalAnchor", AR.ERROR.TYPE
                    .OBJECT, "HORIZONTAL_ANCHOR.___", typeof a)
            }
            return a
        },
        validateVerticalAnchor: function(a) {
            if (!AR.CONST.VERTICAL_ANCHOR.isValidVerticalAnchor(a)) {
                throw AR.ERROR.create("verticalAnchor", AR.ERROR.TYPE
                    .OBJECT, "VERTICAL_ANCHOR.___", typeof a)
            }
            return a
        },
        validateScale: function(a) {
            ...
            if (!AR.VALIDATE.isNonNegative(a)) {
                throw AR.ERROR.create("scale", AR.ERROR.TYPE.RANGE,
                    "[0, infitity)")
            }
            return a
        },
        ...
        validateOpacity: function(a) {
            ...
            if (!AR.VALIDATE.isInRange(a, 0, 1)) {
                throw AR.ERROR.create("opacity", AR.ERROR.TYPE.RANGE,
                    "[0, 1]")
            }
            return a
        },
    ...
    AR.Label = AR.Drawable2D.extend({
        init: function(h, b, c) {
            ...
            var g = this._super(AR.CONST.HORIZONTAL_ANCHOR.CENTER,
                AR.CONST.VERTICAL_ANCHOR.MIDDLE, c);
            ...
            this.__defineSetter__("__id", function(i) {
                throw AR.ERROR.create("__id", AR.ERROR.TYPE
                    .IMMUTABLE)
            });
        ...
        validateHeight: function(a) {
            if ((!AR.VALIDATE.isDefined(a)) || !AR.VALIDATE.isNonNegative(
                    a)) {
                throw AR.ERROR.create("height", AR.ERROR.TYPE.RANGE,
                    "(0, infinity)")
            }
            return a
        }
    ...
    AR.Model = AR.Drawable.extend({
        init: function(b, i) {
            ...
            var e = _PROPERTY_VALIDATOR.validate("uri", b,
                _PROPERTY_VALIDATOR.TYPE.STRING,
                _PROPERTY_VALIDATOR.RULE.MUST_BE_SET);
            var c, d;
            var g = new AR.ModelScale(this, i && i.scale ? i.scale :
                undefined);
            var a = new AR.ModelTranslate(this, i ? i.translate :
                null);
            if (i) {
                if (i.onLoaded) {
                    c = _PROPERTY_VALIDATOR.validate("onLoaded", i.onLoaded,
                        _PROPERTY_VALIDATOR.TYPE.FUNCTION,
                        _PROPERTY_VALIDATOR.RULE.CAN_BE_EMPTY)
                }
                if (i.onError) {
                    d = _PROPERTY_VALIDATOR.validate("onError", i.onError,
                        _PROPERTY_VALIDATOR.TYPE.FUNCTION,
                        _PROPERTY_VALIDATOR.RULE.CAN_BE_EMPTY)
                }
            }
            ...
            this.__defineSetter__("onLoaded", function(j) {
                j = _PROPERTY_VALIDATOR.validate("onLoaded",
                    j, _PROPERTY_VALIDATOR.TYPE.FUNCTION,
                    _PROPERTY_VALIDATOR.RULE.CAN_BE_EMPTY
                );
                c = j;
                AR.i.callAsync({
            ...
            this.__defineSetter__("onError", function(j) {
                j = _PROPERTY_VALIDATOR.validate("onError",
                    j, _PROPERTY_VALIDATOR.TYPE.FUNCTION,
                    _PROPERTY_VALIDATOR.RULE.CAN_BE_EMPTY
                );
                d = j;
    ...
    AR.ModelScale = PClass.create({
        init: function(e, d) {
            ...
            if (d && (typeof d != "object")) {
                throw AR.ERROR.create("scale", AR.ERROR.TYPE.OBJECT,
                    "scale")
            }
            if (d) {
                if (d.x != null) {
                    c = _PROPERTY_VALIDATOR.validate("scale.x", d.x,
                        _PROPERTY_VALIDATOR.TYPE.NON_NEGATIVE,
                        _PROPERTY_VALIDATOR.RULE.CAN_BE_EMPTY)
                }
                if (d.y != null) {
                    b = _PROPERTY_VALIDATOR.validate("scale.y", d.y,
                        _PROPERTY_VALIDATOR.TYPE.NON_NEGATIVE,
                        _PROPERTY_VALIDATOR.RULE.CAN_BE_EMPTY)
                }
                if (d.z != null) {
                    a = _PROPERTY_VALIDATOR.validate("scale.z", d.z,
                        _PROPERTY_VALIDATOR.TYPE.NON_NEGATIVE,
                        _PROPERTY_VALIDATOR.RULE.CAN_BE_EMPTY)
                }
            }
            ...
            this.__defineSetter__("x", function(g) {
                c = _PROPERTY_VALIDATOR.validate("scale.x",
                    g, _PROPERTY_VALIDATOR.TYPE.NON_NEGATIVE,
                    _PROPERTY_VALIDATOR.RULE.CAN_BE_EMPTY
                );
                AR.i.callAsync({
                    objectId: f.__id,
            ...
            this.__defineGetter__("x", function() {
                if (!f.__modelNotCreatedInCoreYet && f.__isDirty(
                        "scale.x")) {
                    return AR.i.callSync({
                        objectId: f.__id,
            ...
            this.__defineSetter__("y", function(g) {
                b = _PROPERTY_VALIDATOR.validate("scale.y",
                    g, _PROPERTY_VALIDATOR.TYPE.NON_NEGATIVE,
                    _PROPERTY_VALIDATOR.RULE.CAN_BE_EMPTY
                );
                AR.i.callAsync({
            ...
            this.__defineSetter__("z", function(g) {
                a = _PROPERTY_VALIDATOR.validate("scale.z",
                    g, _PROPERTY_VALIDATOR.TYPE.NON_NEGATIVE,
                    _PROPERTY_VALIDATOR.RULE.CAN_BE_EMPTY
                );
                AR.i.callAsync({
    ...
    AR.ModelTranslate = PClass.create({
        init: function(e, d) {
            ...
            var a = 0;
            if (d && (typeof d != "object")) {
                throw AR.ERROR.create("translate", AR.ERROR.TYPE.OBJECT,
                    "translate")
            }
            if (d) {
                if (d.x) {
                    c = _PROPERTY_VALIDATOR.validate("translate.x",
                        d.x, _PROPERTY_VALIDATOR.TYPE.NUMERIC,
                        _PROPERTY_VALIDATOR.RULE.MUST_BE_SET)
                }
                if (d.y) {
                    b = _PROPERTY_VALIDATOR.validate("translate.y",
                        d.y, _PROPERTY_VALIDATOR.TYPE.NUMERIC,
                        _PROPERTY_VALIDATOR.RULE.MUST_BE_SET)
                }
                if (d.z) {
                    a = _PROPERTY_VALIDATOR.validate("translate.z",
                        d.z, _PROPERTY_VALIDATOR.TYPE.NUMERIC,
                        _PROPERTY_VALIDATOR.RULE.MUST_BE_SET)
                }
            }
            if (!f.__modelNotCreatedInCoreYet) {
    ...
    AR.Circle = AR.Drawable2D.extend({
        init: function(b, c) {
            ...
            var f = this._super(AR.CONST.HORIZONTAL_ANCHOR.CENTER,
                AR.CONST.VERTICAL_ANCHOR.MIDDLE, c);
            var d = AR.om.createObjectID();
            AR.i.callAsync({
                objectId: d,
        ...
        validateRadius: function(a) {
            if (!AR.VALIDATE.isNonNegative(a)) {
                throw AR.ERROR.create("radius", AR.ERROR.TYPE.RANGE,
                    "(0, infinity)")
            }
            return a
        }
    ...
    AR.HtmlDrawable = AR.Drawable2D.extend({
        init: function(m, k, d) {
            var o = function(s) {
                if (s.indexOf("<body") == -1) {
                    return
                        "<html><head/><body style='background:transparent;margin:0;'>" +
                        s + "</body></html>"
                } else {
                    return s
                }
            ...
            a = _PROPERTY_VALIDATOR.validate("content.html", m.html,
                _PROPERTY_VALIDATOR.TYPE.STRING,
                _PROPERTY_VALIDATOR.RULE.CAN_BE_EMPTY);
            i = _PROPERTY_VALIDATOR.validate("content.uri", m.uri,
                _PROPERTY_VALIDATOR.TYPE.STRING,
                _PROPERTY_VALIDATOR.RULE.CAN_BE_EMPTY);
            var f = _PROPERTY_VALIDATOR.validate("width", k,
                _PROPERTY_VALIDATOR.TYPE.NON_NEGATIVE,
                _PROPERTY_VALIDATOR.RULE.MUST_BE_SET);
            if (!a && !i) {
                throw AR.ERROR.create(
                    "content.html and content.uri", AR.ERROR.TYPE
                    .UNDEFINED)
            }
            if (d) {
                if (d.onLoaded) {
                    e = _PROPERTY_VALIDATOR.validate("onLoaded", d.onLoaded,
                        _PROPERTY_VALIDATOR.TYPE.FUNCTION,
                        _PROPERTY_VALIDATOR.RULE.CAN_BE_EMPTY)
                }
                if (d.onError) {
                    n = _PROPERTY_VALIDATOR.validate("onError", d.onError,
                        _PROPERTY_VALIDATOR.TYPE.FUNCTION,
                        _PROPERTY_VALIDATOR.RULE.CAN_BE_EMPTY)
                }
                if (d.viewportWidth) {
                    r = _PROPERTY_VALIDATOR.validate(
                        "viewportWidth", d.viewportWidth,
                        _PROPERTY_VALIDATOR.TYPE.POSITIVE_INT,
                        _PROPERTY_VALIDATOR.RULE.CAN_BE_EMPTY);
                    if (r > g) {
                        throw AR.ERROR.create("viewportWidth", AR.ERROR
                            .TYPE.RANGE, "(0, " + g + "]")
                    }
                }
                if (d.backgroundColor) {
                    l = _PROPERTY_VALIDATOR.validate(
                        "backgroundColor", d.backgroundColor,
                        _PROPERTY_VALIDATOR.TYPE.RGBA,
                        _PROPERTY_VALIDATOR.RULE.CAN_BE_EMPTY)
                }
                if (d.updateRate) {
                    if (!AR.HtmlDrawable.UPDATE_RATE.isValidUpdateRate(
                            d.updateRate)) {
                        throw AR.ERROR.create("updateRate", AR.ERROR
                            .TYPE.ENUMERATION,
                            "AR.HtmlDrawable.UPDATE_RATE.___")
                    } else {
                        j = d.updateRate
                    }
                }
                if (d.clickThroughEnabled) {
                    q = _PROPERTY_VALIDATOR.validate(
                        "clickThroughEnabled", d.clickThroughEnabled,
                        _PROPERTY_VALIDATOR.TYPE.BOOLEAN,
                        _PROPERTY_VALIDATOR.RULE.CAN_BE_EMPTY)
                }
                if (d.allowDocumentLocationChanges) {
                    p = _PROPERTY_VALIDATOR.validate(
                        "allowDocumentLocationChanges", d.allowDocumentLocationChanges,
                        _PROPERTY_VALIDATOR.TYPE.BOOLEAN,
                        _PROPERTY_VALIDATOR.RULE.CAN_BE_EMPTY)
                }
                if (d.onDocumentLocationChanged) {
                    b = _PROPERTY_VALIDATOR.validate(
                        "onDocumentLocationChanged", d.onDocumentLocationChanged,
                        _PROPERTY_VALIDATOR.TYPE.FUNCTION,
                        _PROPERTY_VALIDATOR.RULE.CAN_BE_EMPTY)
                }
            }
            ...
            var h = this._super(AR.CONST.HORIZONTAL_ANCHOR.CENTER,
                AR.CONST.VERTICAL_ANCHOR.MIDDLE, d);
            ...
            AR.i.callAsync({
                ...
                onDocumentLocationChangedTriggerActive: b !=
                    null,
                backgroundColor: l
            });
            ...
            this.__defineSetter__("html", function(s) {
                s = _PROPERTY_VALIDATOR.validate("html", s,
                    _PROPERTY_VALIDATOR.TYPE.STRING,
                    _PROPERTY_VALIDATOR.RULE.CAN_BE_EMPTY
                );
                s = o(s);
            ...
            this.__defineSetter__("uri", function(s) {
                s = _PROPERTY_VALIDATOR.validate("uri", s,
                    _PROPERTY_VALIDATOR.TYPE.STRING,
                    _PROPERTY_VALIDATOR.RULE.CAN_BE_EMPTY
                );
                if (s) {
            ...
            this.__defineSetter__("backgroundColor", function(s) {
                s = _PROPERTY_VALIDATOR.validate(
                    "backgroundColor", s,
                    _PROPERTY_VALIDATOR.TYPE.RGBA,
                    _PROPERTY_VALIDATOR.RULE.MUST_BE_SET
                );
            ...
            this.__defineSetter__("width", function(s) {
                s = _PROPERTY_VALIDATOR.validate("width", s,
                    _PROPERTY_VALIDATOR.TYPE.NON_NEGATIVE,
                    _PROPERTY_VALIDATOR.RULE.MUST_BE_SET
                );
                AR.i.callAsync({
            ...
            this.__defineSetter__("viewportWidth", function(s) {
                ...
                if (s > g) {
                    throw AR.ERROR.create("viewportWidth",
                        AR.ERROR.TYPE.RANGE, "(0, " + g +
                        "]")
                }
                AR.i.callAsync({
            ...
            this.__defineSetter__("allowDocumentLocationChanges",
                function(s) {
                    s = _PROPERTY_VALIDATOR.validate(
            ...
            this.__defineGetter__("allowDocumentLocationChanges",
                function() {
                    return p
                });
            this.__defineSetter__("onDocumentLocationChanged",
                function(s) {
                    s = _PROPERTY_VALIDATOR.validate(
                        "onDocumentLocationChanged", s,
                        _PROPERTY_VALIDATOR.TYPE.FUNCTION,
                        _PROPERTY_VALIDATOR.RULE.CAN_BE_EMPTY
                    );
                    b = s;
                    AR.i.callAsync({
                        ...
                        objectId: c,
                        onDocumentLocationChangedTriggerActive: (
                            s != null)
                    })
                });
            this.__defineGetter__("onDocumentLocationChanged",
                function() {
                    return b
                });
            this.__defineSetter__("onLoaded", function(s) {
                s = _PROPERTY_VALIDATOR.validate("onLoaded",
                    s, _PROPERTY_VALIDATOR.TYPE.FUNCTION,
                    _PROPERTY_VALIDATOR.RULE.CAN_BE_EMPTY
                );
                e = s;
                AR.i.callAsync({
            ...
            this.__defineSetter__("onError", function(s) {
                s = _PROPERTY_VALIDATOR.validate("onError",
                    s, _PROPERTY_VALIDATOR.TYPE.FUNCTION,
                    _PROPERTY_VALIDATOR.RULE.CAN_BE_EMPTY
                );
                n = s;
        ...
        evalJavaScript: function(a) {
            _PROPERTY_VALIDATOR.validate("js", a,
                _PROPERTY_VALIDATOR.TYPE.STRING,
                _PROPERTY_VALIDATOR.RULE.MUST_BE_SET);
            AR.i.callAsync({
    ...
    AR.ImageDrawable = AR.Drawable2D.extend({
        init: function(f, a, b) {
            ...
            var d = _PROPERTY_VALIDATOR.validate("height", a,
                _PROPERTY_VALIDATOR.TYPE.NON_NEGATIVE,
                _PROPERTY_VALIDATOR.RULE.MUST_BE_SET);
            var g = this._super(AR.CONST.HORIZONTAL_ANCHOR.CENTER,
                AR.CONST.VERTICAL_ANCHOR.MIDDLE, b);
            ...
            this.__defineSetter__("height", function(h) {
                h = _PROPERTY_VALIDATOR.validate("height",
                    h, _PROPERTY_VALIDATOR.TYPE.NON_NEGATIVE,
                    _PROPERTY_VALIDATOR.RULE.MUST_BE_SET
                );
                AR.i.callAsync({
    ...
    AR.AnimatedImageDrawable = AR.ImageDrawable.extend({
        init: function(f, j, i, c, k) {
            var a = _PROPERTY_VALIDATOR.validate("keyFrameWidth", i,
                _PROPERTY_VALIDATOR.TYPE.POSITIVE_INT,
                _PROPERTY_VALIDATOR.RULE.MUST_BE_SET);
            var d = _PROPERTY_VALIDATOR.validate("keyFrameHeight",
                c, _PROPERTY_VALIDATOR.TYPE.POSITIVE_INT,
                _PROPERTY_VALIDATOR.RULE.MUST_BE_SET);
            var h = 0;
            var e;
            if (k) {
                if (k.keyFrame) {
                    h = _PROPERTY_VALIDATOR.validate("keyFrame", k.keyFrame,
                        _PROPERTY_VALIDATOR.TYPE.NON_NEGATIVE_INT,
                        _PROPERTY_VALIDATOR.RULE.MUST_BE_SET)
                }
                if (k.onFinish) {
                    e = _PROPERTY_VALIDATOR.validate("onFinish", k.onFinish,
                        _PROPERTY_VALIDATOR.TYPE.FUNCTION,
                        _PROPERTY_VALIDATOR.RULE.CAN_BE_EMPTY)
                }
            }
            ...
            this.__defineSetter__("onFinish", function(l) {
                l = _PROPERTY_VALIDATOR.validate("onFinish",
                    l, _PROPERTY_VALIDATOR.TYPE.FUNCTION,
                    _PROPERTY_VALIDATOR.RULE.CAN_BE_EMPTY
                );
                e = l;
                AR.i.callAsync({
        ...
        setKeyFrame: function(a) {
            var b = _PROPERTY_VALIDATOR.validate("keyFramePos", a,
                _PROPERTY_VALIDATOR.TYPE.INT,
                _PROPERTY_VALIDATOR.RULE.MUST_BE_SET);
            AR.i.callAsync({
                objectId: this.__id,
        ...
        animate: function(c, e, b) {
            ...
            var f = _PROPERTY_VALIDATOR.validate("duration", e,
                _PROPERTY_VALIDATOR.TYPE.POSITIVE_INT,
                _PROPERTY_VALIDATOR.RULE.MUST_BE_SET);
            var a = 1;
            if (b) {
                a = _PROPERTY_VALIDATOR.validate("loopTimes", b,
                    _PROPERTY_VALIDATOR.TYPE.INT,
                    _PROPERTY_VALIDATOR.RULE.MUST_BE_SET)
            }
            AR.i.callAsync({
        ...
        validateKeyFrameArray: function(b) {
            ...
            for (var a = 0; a < b.length; a++) {
                if (!(typeof b[a] == "number" && Math.round(b[a]) ==
                        b[a])) {
                    throw AR.ERROR.create(name, AR.ERROR.TYPE.ARRAY_CONTENT)
                }
            }
    ...
    AR.GeoLocation = AR.Location.extend({
        ...
        validateLatitude: function(a) {
            ...
            if (!AR.VALIDATE.isInRange(a, -90, 90)) {
                throw AR.ERROR.create("latitude", AR.ERROR.TYPE.RANGE,
                    "[-90, 90]")
            }
            return a
        },
        validateLongitude: function(a) {
            ...
            if (!AR.VALIDATE.isInRange(a, -180, 180)) {
                throw AR.ERROR.create("longitude", AR.ERROR.TYPE.RANGE,
                    "[-180, 180]")
            }
            return a
        },
    ...
    AR.RelativeLocation = AR.Location.extend({
        init: function(g, a, e, c) {
            ...
            var b = _PROPERTY_VALIDATOR.validate("northing", a,
                _PROPERTY_VALIDATOR.TYPE.NUMERIC,
                _PROPERTY_VALIDATOR.RULE.MUST_BE_SET);
            var d = _PROPERTY_VALIDATOR.validate("easting", e,
                _PROPERTY_VALIDATOR.TYPE.NUMERIC,
                _PROPERTY_VALIDATOR.RULE.MUST_BE_SET);
            var i = _PROPERTY_VALIDATOR.validate("altitudeDelta", c,
                _PROPERTY_VALIDATOR.TYPE.NUMERIC,
                _PROPERTY_VALIDATOR.RULE.CAN_BE_EMPTY);
            if (!i) {
                i = 0
            ...
            this.__defineSetter__("location", function(j) {
                j = _PROPERTY_VALIDATOR.validate("location",
                    j, {
                        type: _PROPERTY_VALIDATOR.TYPE.CLASS,
                        ofType: AR.Location
                    }, _PROPERTY_VALIDATOR.RULE.CAN_BE_EMPTY
            ...
            this.__defineSetter__("northing", function(j) {
                j = _PROPERTY_VALIDATOR.validate("northing",
                    j, _PROPERTY_VALIDATOR.TYPE.NUMERIC,
                    _PROPERTY_VALIDATOR.RULE.MUST_BE_SET
                );
                AR.i.callAsync({
            ...
            this.__defineSetter__("easting", function(j) {
                j = _PROPERTY_VALIDATOR.validate("easting",
                    j, _PROPERTY_VALIDATOR.TYPE.NUMERIC,
                    _PROPERTY_VALIDATOR.RULE.MUST_BE_SET
                );
                AR.i.callAsync({
            ...
            this.__defineSetter__("altitudeDelta", function(j) {
                j = _PROPERTY_VALIDATOR.validate(
                    "altitudeDelta", j,
                    _PROPERTY_VALIDATOR.TYPE.NUMERIC,
                    _PROPERTY_VALIDATOR.RULE.CAN_BE_EMPTY
                );
    ...
    AR.GeoObject = AR.ARObject.extend({
        init: function(b, c) {
            ...
            AR.i.callAsync({
                ...
                locationIds: AR.__toJSONString__(AR.om.__getIds__(
                    a)),
                enabled: e.enabled,
                ...
                camDrawableIds: AR.__toJSONString__(AR.om.__getIds__(
                    e.drawables.cam)),
                renderingOrder: e.renderingOrder,
                radarDrawableIds: AR.__toJSONString__(AR.om
                    .__getIds__(e.drawables.radar)),
                indicatorDrawableIds: AR.__toJSONString__(
                    AR.om.__getIds__(e.drawables.indicator)
                )
            });
            AR.om.registerObjectForID(d, this);
            ...
            this.__defineSetter__("locations", function(f) {
                ...
                AR.i.callAsync({
                    objectId: d,
                    locationIds: AR.__toJSONString__(
                        AR.om.__getIds__(f)),
        ...
        validateLocations: function(a) {
            ...
            if (a instanceof AR.Location) {
                ...
                if (!AR.VALIDATE.isArrayOf(a, AR.Location)) {
                    throw AR.ERROR.create("locations", AR.ERROR.TYPE
                        .ARRAY_CONTENT)
                }
            }
            return a
    ...
    AR.ActionArea = AR.ARchitectObject.extend({
        validateOnEnter: function(a) {
            if (AR.VALIDATE.isDefined(a) && !AR.VALIDATE.isFunction(
                    a)) {
                throw AR.ERROR.create("_onEnter", AR.ERROR.TYPE.OBJECT,
                    "function", typeof a)
            }
            return a
        },
        validateOnExit: function(a) {
            if (AR.VALIDATE.isDefined(a) && !AR.VALIDATE.isFunction(
                    a)) {
                throw AR.ERROR.create("_onExit", AR.ERROR.TYPE.OBJECT,
                    "function", typeof a)
            }
            return a
        },
        ...
        isInArea: function(a) {
            ...
            if (!AR.VALIDATE.isTypeOf(a, AR.GeoLocation)) {
                throw AR.ERROR.create("geoLocation", AR.ERROR.TYPE.OBJECT,
                    "geoLocation", typeof val)
            }
            return AR.i.callSync({
                objectId: this.__id,
    ...
    AR.ActionRange = AR.ActionArea.extend({
        ...
        validateLocation: function(a) {
            ...
            if (!AR.VALIDATE.isTypeOf(a, AR.Location)) {
                throw AR.ERROR.create("location", AR.ERROR.TYPE.OBJECT,
                    "Location", typeof a)
            }
            return a
        }
    ...
    AR.ImageResource = AR.ARchitectObject.extend({
        ...
        validateOnLoaded: function(a) {
            if (AR.VALIDATE.isDefined(a) && !AR.VALIDATE.isFunction(
                    a)) {
                throw AR.ERROR.create("onLoaded", AR.ERROR.TYPE.OBJECT,
                    "function", typeof a)
            }
            return a
        },
        validateOnError: function(a) {
            if (AR.VALIDATE.isDefined(a) && !AR.VALIDATE.isFunction(
                    a)) {
                throw AR.ERROR.create("onError", AR.ERROR.TYPE.OBJECT,
                    "function", typeof a)
            }
            return a
        },
    ...
    AR.Animation = AR.ARchitectObject.extend({
        init: function(a) {
            ...
            var b = null;
            if (a != null) {
                c = _PROPERTY_VALIDATOR.validate("onStart", a.onStart,
                    _PROPERTY_VALIDATOR.TYPE.FUNCTION,
                    _PROPERTY_VALIDATOR.RULE.CAN_BE_EMPTY);
                b = _PROPERTY_VALIDATOR.validate("onFinish", a.onFinish,
                    _PROPERTY_VALIDATOR.TYPE.FUNCTION,
                    _PROPERTY_VALIDATOR.RULE.CAN_BE_EMPTY)
            }
            this.__defineSetter__("onStart", function(d) {
                d = _PROPERTY_VALIDATOR.validate("onStart",
                    d, _PROPERTY_VALIDATOR.TYPE.FUNCTION,
                    _PROPERTY_VALIDATOR.RULE.CAN_BE_EMPTY
                );
                c = d;
                AR.i.callAsync({
            ...
            this.__defineSetter__("onFinish", function(d) {
                d = _PROPERTY_VALIDATOR.validate("onFinish",
                    d, _PROPERTY_VALIDATOR.TYPE.FUNCTION,
                    _PROPERTY_VALIDATOR.RULE.CAN_BE_EMPTY
                );
                b = d;
        ...
        start: function(a) {
            a = _PROPERTY_VALIDATOR.validate("loopTimes", a,
                _PROPERTY_VALIDATOR.TYPE.INT,
                _PROPERTY_VALIDATOR.RULE.CAN_BE_EMPTY);
            if (!a && a != 0) {
                a = 1
    ...
    AR.PropertyAnimation = AR.Animation.extend({
        init: function(s, j, g, e, a, p, d) {
            ...
            var n = _PROPERTY_VALIDATOR.validate("property", j,
                _PROPERTY_VALIDATOR.TYPE.STRING,
                _PROPERTY_VALIDATOR.RULE.MUST_BE_SET);
            var b = m;
            var h = n.split(".");
            ...
            if (b[h[h.length - 1]] == null || typeof b[h[h.length -
                    1]] != "number") {
                throw AR.ERROR.ERROR_PREFIX + "Property " + n +
                    " is not animateable."
            }
            var r = _PROPERTY_VALIDATOR.validate("start", g,
                _PROPERTY_VALIDATOR.TYPE.NUMERIC,
                _PROPERTY_VALIDATOR.RULE.CAN_BE_EMPTY);
            if (r != null && r != undefined) {
                r = "[" + r + "]"
            }
            var l = "[" + _PROPERTY_VALIDATOR.validate("end", e,
                _PROPERTY_VALIDATOR.TYPE.NUMERIC,
                _PROPERTY_VALIDATOR.RULE.MUST_BE_SET) + "]";
            var f = _PROPERTY_VALIDATOR.validate("duration", a,
                _PROPERTY_VALIDATOR.TYPE.NON_NEGATIVE,
                _PROPERTY_VALIDATOR.RULE.MUST_BE_SET);
            if (!p || !(p.type)) {
                p = {
        ...
        validateEasingCurve: function(a) {
            ...
            if (!AR.CONST.EASING_CURVE_TYPE.isValidEasingCurveType(
                    a.type)) {
                throw AR.ERROR.create("easingCurve.type", AR.ERROR.TYPE
                    .ENUMERATION,
                    "AR.CONST.EASING_CURVE_TYPE.___")
            }
            if (AR.VALIDATE.isDefined(a.amplitude) && !AR.VALIDATE.isNumeric(
                    a.amplitude)) {
                throw AR.ERROR.create("easingCurve.amplitude", AR.ERROR
                    .TYPE.FLOAT)
            }
            if (AR.VALIDATE.isDefined(a.period) && !AR.VALIDATE.isNumeric(
                    a.period)) {
                throw AR.ERROR.create("easingCurve.period", AR.ERROR
                    .TYPE.FLOAT)
            }
            if (AR.VALIDATE.isDefined(a.overshoot) && !AR.VALIDATE.isNumeric(
                    a.overshoot)) {
                throw AR.ERROR.create("easingCurve.overshoot", AR.ERROR
                    .TYPE.FLOAT)
            }
            return a
        }
    ...
    AR.AnimationGroup = AR.Animation.extend({
        init: function(d, g, b) {
            var f = this._super(b);
            if (!AR.CONST.ANIMATION_GROUP_TYPE.isValidAnimationGroupType(
                    d)) {
                throw AR.ERROR.create(d, AR.ERROR.TYPE.OBJECT,
                    "AR.CONST.ANIMATION_GROUP_TYPE")
            }
            var a = d;
            ...
            AR.i.callAsync({
                ...
                type: a,
                animationIds: AR.__toJSONString__(AR.om.__getIds__(
                    e)),
    ...
    AR.Sound = AR.ARchitectObject.extend({
        init: function(f, d) {
            ...
            this.__defineSetter__("state", function(i) {
                throw AR.ERROR.create("state", AR.ERROR.TYPE
                    .IMMUTABLE)
            });
            ...
            this.__defineSetter__("onFinishedPlaying", function(i) {
                ...
                AR.i.callAsync({
                    ...
                    onFinishedPlayingTriggerActive: i !=
                        null
                })
            });
        ...
        validateOnX: function(a, b) {
            if (AR.VALIDATE.isDefined(b) && !AR.VALIDATE.isFunction(
                    b)) {
                throw AR.ERROR.create(a, AR.ERROR.TYPE.OBJECT,
                    "function", typeof b)
            }
        ...
        play: function(a) {
            if (a === undefined) {
                ...
                if (!AR.VALIDATE.isWholeNumber(a)) {
                    throw AR.ERROR.create("loopTimes", AR.ERROR.TYPE
                        .INT)
                }
            }
            AR.i.callAsync({
    ...
    AR.Style = PClass.create({
        ...
        validateOutlineSize: function(a) {
            ...
            if (!AR.VALIDATE.isInRange(a, 0, 128)) {
                throw AR.ERROR.create("outlineSize", AR.ERROR.TYPE.RANGE,
                    "[0, 128]")
            }
            return a
        },
        validateFontStyle: function(a) {
            ...
            if (!AR.CONST.FONT_STYLE.isValidFontStyle(a)) {
                throw AR.ERROR.create("fontStyle", AR.ERROR.TYPE.RANGE,
                    "AR.CONST.FONT_STYLE.___")
            }
            return a
        },
        init: function(d, h) {
    ...
    AR.OneTimeUseContextConstructionPlan = PClass.create({
        ...
        init: function() {
            ...
            this.__defineSetter__("onScreenClick", function(f) {
                f = this.validateFunction("onScreenClick",
                    f);
                _onScreenClick = f;
                AR.i.callAsync({
                    is: "AR.i.contextInterface.setOnScreenClickTriggerActive",
                    onScreenClickTriggerActive: _onScreenClick !=
                        null
                })
            });
            ...
            this.__defineSetter__("destroyAll", function(f) {
                throw AR.ERROR.create("destroyAll", AR.ERROR
                    .TYPE.IMMUTABLE)
            });
            ...
            this.__defineSetter__("clickBehavior", function(f) {
                if (f != AR.CONST.CLICK_BEHAVIOR.CLICK && f !=
                    AR.CONST.CLICK_BEHAVIOR.TOUCH_UP && f !=
                    AR.CONST.CLICK_BEHAVIOR.TOUCH_DOWN) {
                    throw AR.ERROR.create("clickBehavior",
                        AR.ERROR.TYPE.OBJECT,
                        "CLICK_BEHAVIOR.___", typeof f)
                }
                _clickBehavior = f;
                AR.js.clickBehavior.setClickBehavior(
                    _clickBehavior)
            });
            ...
            this.__defineSetter__("services", function(f) {
                throw AR.ERROR.create("services", AR.ERROR.TYPE
                    .IMMUTABLE)
            });
            ...
            var e = function() {
                var f = 50000;
                this.__defineGetter__("cullingDistance",
                    function() {
                        return f
                    });
                this.__defineSetter__("cullingDistance",
                    function(g) {
                        g = _PROPERTY_VALIDATOR.validate(
                            "scene.cullingDistance", g,
                            _PROPERTY_VALIDATOR.TYPE.POSITIVE_INT,
                            _PROPERTY_VALIDATOR.RULE.MUST_BE_SET
                        );
                        f = g;
            ...
            this.__defineSetter__("scene", function(f) {
                throw AR.ERROR.create("scene", AR.ERROR.TYPE
                    .IMMUTABLE)
            });
        ...
        openInBrowser: function(a, b) {
            ...
            if (!AR.VALIDATE.isBoolean(b)) {
                throw AR.ERROR.create("forceNativeBrowser", AR.ERROR
                    .TYPE.BOOLEAN)
            }
            AR.i.callAsync({
    ...
    AR.__LOGGER_MESSAGE__ = function(b, c) {
        ...
        this.toString = function(f) {
            var e = this.type.substring(0, 1) + " " + d(this.date) +
                " - " + this.message;
            if (f) {
                return "<font color=" + this.color + ">" + e +
                    "</font>"
            } else {
                return e
            }
    ...
    AR.Tracker = AR.ARchitectObject.extend({
        init: function(g, c) {
            this._super();
            var h = _PROPERTY_VALIDATOR.validate("src", g,
                _PROPERTY_VALIDATOR.TYPE.STRING,
                _PROPERTY_VALIDATOR.RULE.MUST_BE_SET);
            var a = true;
            var e;
            ...
            if (c) {
                if (c.enabled) {
                    a = _PROPERTY_VALIDATOR.validate("enabled", c.enabled,
                        _PROPERTY_VALIDATOR.TYPE.BOOLEAN,
                        _PROPERTY_VALIDATOR.RULE.MUST_BE_SET)
                }
                if (c.onDisabled) {
                    e = _PROPERTY_VALIDATOR.validate("onDisabled",
                        c.onDisabled, _PROPERTY_VALIDATOR.TYPE.FUNCTION,
                        _PROPERTY_VALIDATOR.RULE.CAN_BE_EMPTY)
                }
                if (c.onLoaded) {
                    f = _PROPERTY_VALIDATOR.validate("onLoaded", c.onLoaded,
                        _PROPERTY_VALIDATOR.TYPE.FUNCTION,
                        _PROPERTY_VALIDATOR.RULE.CAN_BE_EMPTY)
                }
                if (c.onError) {
                    b = _PROPERTY_VALIDATOR.validate("onError", c.onError,
                        _PROPERTY_VALIDATOR.TYPE.FUNCTION,
                        _PROPERTY_VALIDATOR.RULE.CAN_BE_EMPTY)
                }
            }
            ...
            this.__defineSetter__("enabled", function(i) {
                i = _PROPERTY_VALIDATOR.validate("enabled",
                    i, _PROPERTY_VALIDATOR.TYPE.BOOLEAN,
                    _PROPERTY_VALIDATOR.RULE.MUST_BE_SET
                );
                AR.i.callAsync({
                    objectId: d,
            ...
            this.__defineSetter__("onLoaded", function(i) {
                i = _PROPERTY_VALIDATOR.validate("onLoaded",
                    i, _PROPERTY_VALIDATOR.TYPE.FUNCTION,
                    _PROPERTY_VALIDATOR.RULE.CAN_BE_EMPTY
                );
                f = i;
                AR.i.callAsync({
            ...
            this.__defineSetter__("onError", function(i) {
                i = _PROPERTY_VALIDATOR.validate("onError",
                    i, _PROPERTY_VALIDATOR.TYPE.FUNCTION,
                    _PROPERTY_VALIDATOR.RULE.CAN_BE_EMPTY
                );
                b = i;
    ...
    AR.Trackable2DObject = AR.ARObject.extend({
        init: function(f, e, c) {
            ...
            var a = _PROPERTY_VALIDATOR.validate("targetName", e,
                _PROPERTY_VALIDATOR.TYPE.STRING,
                _PROPERTY_VALIDATOR.RULE.MUST_BE_SET);
            var d = AR.om.createObjectID();
            AR.i.callAsync({
            ...
            this.__defineSetter__("tracker", function(h) {
                throw AR.ERROR.create("tracker", AR.ERROR.TYPE
                    .IMMUTABLE)
            });
            ...
            this.__defineSetter__("targetName", function(h) {
                throw AR.ERROR.create("targetName", AR.ERROR
                    .TYPE.IMMUTABLE)
            });
            ...
            this.__defineSetter__("width", function(h) {
                throw AR.ERROR.create("width", AR.ERROR.TYPE
                    .IMMUTABLE)
            });
            this.__defineGetter__("width", function() {
                var h = AR.i.callSync({
            ...
            this.__defineSetter__("height", function(h) {
                throw AR.ERROR.create("height", AR.ERROR.TYPE
                    .IMMUTABLE)
            });
            this.__defineGetter__("height", function() {
                var h = AR.i.callSync({
    ...
    AR.OneTimeUseRadarConstructionPlan = PClass.create({
        init: function() {
            ...
            this.__defineSetter__("enabled", function(l) {
                l = _PROPERTY_VALIDATOR.validate("enabled",
                    l, _PROPERTY_VALIDATOR.TYPE.BOOLEAN,
                    _PROPERTY_VALIDATOR.RULE.MUST_BE_SET
                );
                f = l;
                AR.i.callAsync({
            ...
            this.__defineSetter__("background", function(l) {
                ...
                AR.i.callAsync({
                    ...
                    backgroundId: (l == null || l ==
                        undefined ? null : l.__id
                    )
                })
            });
            ...
            this.__defineSetter__("positionX", function(l) {
                l = _PROPERTY_VALIDATOR.validate(
                    "positionX", l, _PROPERTY_VALIDATOR
                    .TYPE.UNIT_INTERVAL,
                    _PROPERTY_VALIDATOR.RULE.MUST_BE_SET
                );
                j = l;
            ...
            this.__defineSetter__("positionY", function(l) {
                l = _PROPERTY_VALIDATOR.validate(
                    "positionY", l, _PROPERTY_VALIDATOR
                    .TYPE.UNIT_INTERVAL,
                    _PROPERTY_VALIDATOR.RULE.MUST_BE_SET
                );
                i = l;
            ...
            this.__defineSetter__("width", function(l) {
                l = _PROPERTY_VALIDATOR.validate("width", l,
                    _PROPERTY_VALIDATOR.TYPE.UNIT_INTERVAL,
                    _PROPERTY_VALIDATOR.RULE.MUST_BE_SET
                );
                e = l;
                AR.i.callAsync({
            ...
            this.__defineSetter__("centerX", function(l) {
                l = _PROPERTY_VALIDATOR.validate("centerX",
                    l, _PROPERTY_VALIDATOR.TYPE.UNIT_INTERVAL,
                    _PROPERTY_VALIDATOR.RULE.MUST_BE_SET
                );
                d = l;
                AR.i.callAsync({
            ...
            this.__defineSetter__("centerY", function(l) {
                l = _PROPERTY_VALIDATOR.validate("centerY",
                    l, _PROPERTY_VALIDATOR.TYPE.UNIT_INTERVAL,
                    _PROPERTY_VALIDATOR.RULE.MUST_BE_SET
                );
                c = l;
            ...
            this.__defineSetter__("radius", function(l) {
                l = _PROPERTY_VALIDATOR.validate("radius",
                    l, _PROPERTY_VALIDATOR.TYPE.UNIT_INTERVAL,
                    _PROPERTY_VALIDATOR.RULE.MUST_BE_SET
                );
                a = l;
            ...
            this.__defineSetter__("maxDistance", function(l) {
                l = _PROPERTY_VALIDATOR.validate(
                    "maxDistance", l,
                    _PROPERTY_VALIDATOR.TYPE.POSITIVE,
                    _PROPERTY_VALIDATOR.RULE.CAN_BE_EMPTY
                );
                k = l;
                AR.i.callAsync({
            ...
            this.__defineSetter__("northIndicator", function(l) {
                throw AR.ERROR.create("northIndicator", AR.ERROR
                    .TYPE.IMMUTABLE)
            });
            ...
            this.__defineSetter__("onClick", function(l) {
                l = _PROPERTY_VALIDATOR.validate("onClick",
                    l, _PROPERTY_VALIDATOR.TYPE.FUNCTION,
                    _PROPERTY_VALIDATOR.RULE.CAN_BE_EMPTY
                );
                g = l;
    ...
    printStackTrace.implementation.prototype = {
        ...
        deinstrumentFunction: function(a, b) {
            if (a[b].constructor === Function && a[b]._instrumented &&
                a["_old" + b].constructor === Function) {
                a[b] = a["_old" + b]
            }
        },
        chrome: function(a) {
            return a.stack.replace(/^[^\(]+?[\n$]/gm, "").replace(
                /^\s+at\s+/gm, "").replace(
                /^Object.<anonymous>\s*\(/gm, "{anonymous}()@").split(
                "\n")
        },
        firefox: function(a) {
            return a.stack.replace(/(?:\n@:0)?\s+$/m, "").replace(
        ...
        opera10: function(g) {
            ...
            var m = k.split("\n"),
                a = "{anonymous}",
                h =
                /.*line (\d+), column (\d+) in ((<anonymous function\:?\s*(\S+))|([^\(]+)\([^\)]*\))(?: in )?(.*)\s*$/i,
                d, c, f;
            for (d = 2, c = 0, f = m.length; d < f - 2; d++) {
                if (h.test(m[d])) {
                    var l = RegExp.$6 + ":" + RegExp.$1 + ":" + RegExp.$2;
                    var b = RegExp.$3;
                    b = b.replace(/<anonymous function\:?\s?(\S+)?>/g,
                        a);
                    m[c++] = b + "@" + l
                }
            }
        ...
        opera: function(h) {
            var c = h.message.split("\n"),
                b = "{anonymous}",
                g =
                /Line\s+(\d+).*script\s+(http\S+)(?:.*in\s+function\s+(\S+))?/i,
                f, d, a;
            for (f = 4, d = 0, a = c.length; f < a; f += 2) {
                if (g.test(c[f])) {
                    c[d++] = (RegExp.$3 ? RegExp.$3 + "()@" + RegExp.$2 +
                        RegExp.$1 : b + "()@" + RegExp.$2 + ":" +
                        RegExp.$1) + " -- " + c[f + 1].replace(
                        /^\s+/, "")
                }
            }
                    ...
                    if (a === null) {
                        ...
                        if (a.constructor) {
                            if (a.constructor === Array) {
                                if (a.length < 3) {
                                    b[c] = "[" + this.stringifyArguments(
                                        a) + "]"
                                } else {
                                    b[c] = "[" + this.stringifyArguments(
                                            Array.prototype.slice.call(
                                                a, 0, 1)) + "..." +
                                        this.stringifyArguments(Array.prototype
                                            .slice.call(a, -1)) + "]"
                                }
                            } else {
        ...
        createXMLHTTPObject: function() {
            ...
            for (var b = 0; b < a.length; b++) {
                try {
                    ...
                    if (AR.i.contextInterface.info) {
                        AR.i.contextInterface.info("Exception caught: " +
                            d)
                    }
                }
            }
        ...
        guessFunctionName: function(b, d) {
            ...
            try {
                ...
                a = "getSource failed with url: " + b + ", exception: " +
                    c.toString();
                if (AR.i.contextInterface.info) {
    ...
    AR.overlay.__OVERLAY_CONTAINER__CONSTRUCTION_PLAN = function() {
        ...
        var k = function() {
            ...
            var p = "";
            p +=
                "div.__OVERLAY__mainDiv {-webkit-box-shadow: #333 0px 0px 10px 0px; box-shadow: #333 0px 0px 10px 0px; background: #F0F0F0; position: absolute;top: 5%;left: 5%;right: 5%;bottom: 5%;z-index: 2147483647;padding: 20px;overflow: auto;font-family:Verdana;font-size:small;}";
            p += "input.__OVERLAY__closeButton {float: right;}";
            p +=
                "div.__OVERLAY__openButton {position: absolute;right: 0px;bottom: 0px;z-index: 2147483647;width: 0; height: 0; border-bottom: 40px solid #FF8C0A; border-left: 40px solid transparent; }";
            p +=
                "div.__OVERLAY__tab {margin-right:2px;border-style: groove;margin-bottom:1px;width: 30%;background: #F0F0F0;text-align: center;vertical-align: middle;font-weight: bold;height: 20px;border-top-left-radius:20px;border-top-right-radius:20px;cursor:pointer;cursor: pointer;border-width: 1px;border-color: black;}";
            p +=
                "#toolTipDiv {font-family:Verdana; position: absolute;right: 5px;bottom: 65px;width: 220px;background-color: #FFBB24;padding-bottom: 5px;padding-top: 5px;z-index: 2147483646;}";
            p +=
                "#toolTipDiv:before {  content: ' ';  position: absolute;  right: 20px;bottom: -40px;border: 20px solid;border-color: #FFBB24 #FFBB24 transparent transparent;}";
        ...
        this.appendOverlay = function(r, s, p) {
            ...
            q.setAttribute("style", "margin-left:" + (31 * f) + "%;" +
                (f == 0 ? "float:left;" : ""));
        ...
        var o = function() {
            ...
            p.innerHTML =
                "Open Logger and/or ADE by pressing this button";
            if (document.body) {
    ...
    var __ARCHITECT_LOGGER_FRAMEWORK__ = new function() {
        ...
        var h = function() {
            ...
            var m = "";
            m +=
                "div.__LOGGER__logSelector {cursor:pointer; border: 1px solid black; border-radius:20px; width: 99%;float: left;font-size: large;margin-top: 0.3%;padding: 0.3%;text-align: center;margin-bottom: 0.3%;}";
            m +=
                "div.__LOGGER__messagesContainer {width: 99%;overflow: auto;font-family: monospace;margin-top: 5px;}";
            m +=
                "table.__LOGGER__selectorTable {width: 100%;table-layout: fixed;}";
            m +=
                "div.__LOGGER__logMessage{font-family:monospace;} div.red {color:red;} div.green {color:green;} div.orange {color:orange;} div.black {color:black;}";
            m +=
                "#__LOGGER__ARCHITECT_ERROR_LOG_CONSOLE {width : 100%; overflow : auto; font-family: monospace;}";
        ...
        var j = function() {
            function u(z, x, A, y) {
                ...
                B.onclick = function() {
                    __ARCHITECT_LOGGER_FRAMEWORK__.__toggleLogLevel__(
                        x)
                };
        ...
        var f = function() {
            ...
            m.setAttribute("id",
                "__LOGGER__ARCHITECT_ERROR_LOG_CONSOLE");
        ...
        this.activateDebugMode = function() {
            ...
            b("INFO");
            b("DEBUG");
            var m = AR.overlay.OVERLAY_CONTAINER.appendOverlay("Logger",
                c);
    ...
    AR.ADE.Screen = function() {
        ...
        (function() {
            ...
            m +=
                "#__ADE__tree_div{padding-top:5px;padding-left:20px;min-height:400px;height:auto !important;height:400px; }";
            m +=
                "div.__ADE__header{clear:left;font-weight:bold;padding-bottom: 10px;padding-left: 2px;padding-top: 10px;background-color:#707070; color: white;}";
            m += "#__ADE__treeDivHeader{padding-bottom:12px;}";
            m +=
                "#__ADE__settingsMainBox{float:right;border:2px solid;border-color:#9D9D9D;min-height:100px;height:auto !important;height:100px;}";
            m += "#__ADE__applyButton{margin-right: 5px}";
            m += "#__ADE__saveButton{margin-left: 5px}";
            m +=
                "#__ADE__settingsSubHeader{font-weight: bold;padding: 3px;background-color: #9D9D9D;padding: 3px;margin-top: 2px;font-size: smaller;}";
            m +=
                "div.__ADE__settingsEntryBox{margin-top: 5px;border-bottom: 1px solid;padding: 5px;border-color: #9D9D9D;}div.settingsEntryHeader{font-weight: bold;margin-bottom: 2px;font-size: x-small;}";
            m +=
                "#__ADE__hitARObjectDiv{font-family:Verdana;z-index: 2147483647;position: fixed;top: 50%;left: 50%;background-color: #FFBB24;margin-left: -280px;padding: 20px;border: 2px solid;}";
            o.setAttribute("type", "text/css");
            var n = document.getElementsByTagName("head")[0];
            n.appendChild(o);
            if (o.styleSheet) {
        ...
        var b = function() {
            ...
            var q = document.createTextNode(
                "Receive Constant Location Updates");
            n.appendChild(m);
            n.appendChild(q);
            p.appendChild(n);
            return p
        ...
        var f = function() {
            ...
            r.onchange = function() {
                ...
                document.getElementById("currentLongitude").value =
                    G[1];
                document.getElementById("currentAltitude").value =
                    G[2]
            };
            ...
            for (var z = 0; z < localStorage.length; z++) {
                ...
                if (key.substring(0, i.length) === i) {
                    r.addOption(localStorage.getItem(key), key.substring(
                        i.length))
                }
            }
            D.appendChild(r);
            ...
            var q = function(G) {
                document.getElementById(G).style.backgroundColor =
                    "lightcoral";
                window.setTimeout("document.getElementById('" + G +
                    "').style.backgroundColor = 'white';", 1000
                )
            };
            ...
            var s = function() {
                var I = parseFloat(document.getElementById(
                    "currentLatitude").value);
                var H = parseFloat(document.getElementById(
                    "currentLongitude").value);
                var G = parseFloat(document.getElementById(
                ...
                if (G != null && AR.VALIDATE.isNumeric(G) && !isNaN(
                        G)) {} else {
                    q("currentAltitude");
                    return
                }
            ...
            o.onclick = function() {
                ...
                if (G) {
                    AR.ADE.instance.applyLocationUpdate(G);
                    var H = prompt(
                        "Enter the ID the saved location:", "");
                    if (H) {
                        r.addOption(AR.__toJSONString__(G), H, true);
                        H = i + H;
                        if (!localStorage) {
                            alert(
                                "Your Browser does not support local storage. Values will not be persisted."
                            );
                            return
                        }
                        localStorage.setItem(H, AR.__toJSONString__(
                            G))
                    }
                }
            };
        ...
        this.createWhichARObjectClickedBox = function(q, s) {
            ...
            var n = document.createElement("div");
            n.innerHTML =
                "The Drawable is attached to multiple ARObjects.<br/>Select which attached ARObject was hit with the click.";
            r.appendChild(n);
            r.appendChild(m);
            r.appendChild(o);
        ...
        l.appendChild(h);
        k.appendChild(l);
        var g = AR.overlay.OVERLAY_CONTAINER.appendOverlay("ADE", k,
            function() {
    ...
    AR.ADE.ConstructionPlan = function() {
        ...
        this.applyLocationUncertainity = function() {
            if (AR.ADE.instance.simulateLocation) {
                ...
                if (AR.context.onLocationChanged) {
                    AR.context.onLocationChanged(this.simulatedLocation
                        .latitude, this.simulatedLocation.longitude,
                        this.simulatedLocation.altitude, this.simulatedLocation
                        .accuracy)
                }
            }
        };
        var d = window.setInterval(
            "AR.ADE.instance.applyLocationUncertainity();", 1000);
        ...
        this.applyLocationUpdate = function(f) {
            ...
            if (AR.context.onLocationChanged != null) {
                AR.context.onLocationChanged(AR.ADE.instance.simulatedLocation
                    .latitude, AR.ADE.instance.simulatedLocation.longitude,
                    AR.ADE.instance.simulatedLocation.altitude, AR.ADE
                    .instance.simulatedLocation.accuracy)
            }
        };
        var c = function() {
    ...
    AR.ADE.Tree = function(b) {
                ...
                if (A) {
                    if (A.value != this.referencedId) {
                        ...
                        if (A.value) {
                            ...
                            this.node = new YAHOO.widget.TextNode(x,
                                p.node);
                            o = c(A.value, this)
                        } else {
        ...
        var j = function(u, n, t, r) {
            ...
            var o = [];
            for (var p = 0; p < q.length; p++) {
                o.push(new g(q[p], AR.i.getBridgeObject(q[p]).explain(),
                    this))
            }
            this.update = function(w) {
                ...
                if (true) {
                    ...
                    for (var v = 0; v < y.length; v++) {
                        o.push(new g(y[v], AR.i.getBridgeObject(y[v])
                            .explain(), this))
                    }
                    try {
                        this.node.refresh()
        ...
        var i = function(r, n, q, o) {
            ...
            this.update = function(s) {
                ...
                if (u != this.value) {
                    this.node.setNodesProperty("label", n + ": " +
                        u);
                    this.value = u;
                    try {
                        this.node.parent.refresh()
        ...
        var d = function(s, o, r, p) {
            ...
            var n = function(u, t) {
                return "javascript:AR.ADE.instance.trigger('" + u +
                    "','" + t.trigger + "'" + (t.parameters ? ", '" +
            ...
            this.update = function(t) {
                ...
                this.node.setNodesProperty("href", (v.active ? n(s,
                    v) : null));
                try {
                    this.node.parent.refresh()
                } catch (u) {}
        ...
        var k = function(s, o, r, p) {
            ...
            var n = function(u, t) {
                return "javascript:" + t.interfaceObject + "." + t.functionName +
                    "({objectId : '" + u + "'});"
            };
            var q = {
                label: o,
        ...
        var h = function(s, o, r, p) {
            ...
            var n = function(t) {
                return
                    "javascript:var win=window.open();win.document.write('" +
                    t.value.replace(/\'/g, "\\'") + "');"
            };
            var q = {
                label: o,
            ...
            this.update = function(t) {
                ...
                this.node.setNodesProperty("label", o + ((v && v.value) ?
                    ": " + v.value : ""));
                this.node.setNodesProperty("href", ((v && v.value) ?
                    n(v) : null));
                try {
                    this.node.parent.refresh()
                } catch (u) {}
        ...
        var f = function(s, o, r, p) {
            ...
            this.update = function(t) {
                var v = t.properties[o];
                this.node.setNodesProperty("label", o + (v ? ": " +
                    v.value : ""));
                this.node.setNodesProperty("href", ((v && v.value) ?
                    n(v) : null));
                try {
        ...
        var a = function(s, o, r, p) {
            ...
            var n = function(t) {
                return
                    "javascript:AR.ADE.instance.triggerClickOnDrawable('" +
                    t + "');"
            };
            var q = {
                label: o,
    ...
    AR.i.locationInterface = {
        ...
        distanceToUser: function(c) {
            if (AR.ADE.instance.simulatedLocation) {
                ...
                var d = b.latitude;
                var a = b.longitude;
                return AR.i.locationInterface.calculateDistance(d, AR.ADE
                    .instance.simulatedLocation.latitude, a, AR.ADE
                    .instance.simulatedLocation.longitude)
            }
            return -1
        },
        calculateDistance: function(i, h, g, f) {
            ...
            var b = Math.sin(d / 2) * Math.sin(d / 2) + Math.cos(i *
                    Math.PI / 180) * Math.cos(h * Math.PI / 180) * Math
                .sin(e / 2) * Math.sin(e / 2);
    ...
    AR.i.relativeLocationInterface = {
        ...
        createRelativeLocation: function(a) {
            AR.i.registerBridgeObject({
                ...
                getCurrentLocation: function() {
                    ...
                    var c = AR.i.relativeLocationInterface.calculateNewLocation(
                        d.latitude, d.longitude, d.altitude,
                        a.northing, a.easting, a.altitudeDelta
                    );
                    return {
                        latitude: c.latitude,
        ...
        createRelativeLocationToUser: function(b) {
            var a = AR.i.relativeLocationInterface.calculateNewLocation(
                AR.ADE.instance.simulatedLocation.latitude, AR.ADE.instance
                .simulatedLocation.longitude, AR.ADE.instance.simulatedLocation
                .altitude, b.northing, b.easting, b.altitudeDelta);
            AR.i.registerBridgeObject({
                _id: b.objectId,
        ...
        calculateNewLocation: function(k, a, h, b, g, c) {
            ...
            var f = b > 0 ? 0 : Math.PI;
            e = Math.asin(Math.sin(e) * Math.cos(j) + Math.cos(e) *
                Math.sin(j) * Math.cos(f));
            j = Math.abs(g / 6371000);
            f = g > 0 ? Math.PI / 2 : 3 * Math.PI / 2;
            lat2 = Math.asin(Math.sin(e) * Math.cos(j) + Math.cos(e) *
                Math.sin(j) * Math.cos(f));
            i = i + Math.atan2(Math.sin(f) * Math.sin(j) * Math.cos(e),
                Math.cos(j) - Math.sin(e) * Math.sin(lat2));
            e = lat2;
            return {
                latitude: e * 180 / Math.PI,
                longitude: i * 180 / Math.PI,
                altitude: (h == AR.CONST.UNKNOWN_ALTITUDE ? AR.CONST.UNKNOWN_ALTITUDE :
                    h + c)
            }
        }
    };
    AR.i.arObjectInterface = {
        ...
        setOnEnterFieldOfVisionTriggerActive: function(a) {
            AR.i.getBridgeObject(a.objectId)._onEnterFieldOfVisionTriggerActive =
                a.onEnterFieldOfVisionTriggerActive;
            AR.ADE.instance.alertModification(a.objectId)
        },
        setOnExitFieldOfVisionTriggerActive: function(a) {
            AR.i.getBridgeObject(a.objectId)._onExitFieldOfVisionTriggerActive =
                a.onExitFieldOfVisionTriggerActive;
            AR.ADE.instance.alertModification(a.objectId)
        },
                ...
                explain: function() {
                    return {
                        ...
                        properties: {
                            ...
                            "visible (artificial property)": this
                                ._visible,
                            "Toggle Visibility": {
                                type: "bridgecall",
    ...
    AR.i.actionRangeInterface = {
        ...
        isInArea: function(b, a) {
            return (AR.om.getExistingObjectForID(b).location.distanceTo(
                AR.om.getExistingObjectForID(a)) <= AR.i.getBridgeObject(
                b)._radius)
        }
    };
    ...
    AR.i.modelInterface = {
        ...
        setOnLoadedTriggerActive: function(a) {
            AR.i.getBridgeObject(a.objectId)._onLoadedTriggerActive = a
                .onLoadedTriggerActive;
            AR.ADE.instance.alertModification(a.objectId)
        },
                ...
                explain: function() {
                    return {
                        ...
                        properties: {
                            ...
                            "loaded (artificial property)": this
                                ._loaded
                        }
                    }
                }
                    ...
                    return {
                        ...
                        properties: {
                            ...
                            horizontalAnchor: AR.CONST.HORIZONTAL_ANCHOR
                                .toName(this._horizontalAnchor),
                            verticalAnchor: AR.CONST.VERTICAL_ANCHOR
                                .toName(this._verticalAnchor),
                            scale: this._scale,
    ...
    AR.i.htmlDrawableInterface = {
        ...
        setAllowDocumentLocationChanges: function(a) {
            AR.i.getBridgeObject(a.objectId)._allowDocumentLocationChanges =
                a.allowDocumentLocationChanges;
            AR.ADE.instance.alertModification(a.objectId)
        },
        ...
        setOnDocumentLocationChangedTriggerActive: function(a) {
            AR.i.getBridgeObject(a.objectId)._onDocumentLocationChangedTriggerActive =
                a.onDocumentLocationChangedTriggerActive;
            AR.ADE.instance.alertModification(a.objectId)
        },
        setOnErrorTriggerActive: function(a) {
            AR.i.getBridgeObject(a.objectId)._onErrorTriggerActive = a.onErrorTriggerActive;
                ...
                explain: function() {
                    ...
                    return {
                        ...
                        properties: {
                            ...
                            updateRate: AR.HtmlDrawable.UPDATE_RATE
                                .toName(this._updateRate),
                            enabled: this._enabled,
                            offsetX: this._offsetX,
                            offsetY: this._offsetY,
                            rotation: this._rotation,
                            ...
                            allowDocumentLocationChanges: this
                                ._allowDocumentLocationChanges,
        ...
        onDocumentLocationChanged: function(c) {
            ...
            var a = prompt(
                "Enter the URL the document location will be changed to: "
            );
    ...
    AR.i.animatedImageDrawableInterface = {
        ...
        setOnFinishTriggerActive: function(a) {
            AR.i.getBridgeObject(a.objectId)._onFinishTriggerActive = a
                .onFinishTriggerActive
        },
        animate: function(a) {}
    };
                    ...
                    return {
                        ...
                        properties: {
                            ...
                            onLoaded: {
                                ...
                                active: this._onLoadedTriggerActive,
                                trigger: "onLoaded",
                                parameters: [AR.i.imageResourceInterface
                                    .getWidth({
                                        objectId: a
                                            .objectId
                                    }), AR.i.imageResourceInterface
    ...
    AR.i.soundInterface = {
        ...
        setOnFinishedPlayingTriggerActive: function(a) {
            AR.i.getBridgeObject(a.objectId)._onFinishedPlayingTriggerActive =
                a.onFinishedPlayingTriggerActive;
            AR.ADE.instance.alertModification(a.objectId)
        },
        setOnErrorTriggerActive: function(a) {
            AR.i.getBridgeObject(a.objectId)._onErrorTriggerActive = a.onErrorTriggerActive;
        ...
        simulateStreaming: function(c) {
            ...
            window.setTimeout(function() {
                if (!AR.i.getBridgeObject(c.objectId)._stopped) {
                    if (AR.om.getExistingObjectForID(c.objectId)
                        .onFinishedPlaying) {
                        AR.om.getExistingObjectForID(c.objectId)
                            .onFinishedPlaying()
                    }
                }
            }, 1)
        ...
        getDuration: function(b) {
            ...
            if (a instanceof AR.PropertyAnimation) {
                ...
                if (a instanceof AR.AnimationGroup) {
                    ...
                    if (a instanceof AR.ModelAnimation) {
                        return AR.i.modelAnimationInterface.getDuration(
                            b)
                    }
                }
            }
                    ...
                    return {
                        ...
                        properties: {
                            ...
                            start: (this._start == null ?
                                null : AR.__fromJSONString__(
                                    this._start)[0]),
                            end: AR.__fromJSONString__(this
                                ._end)[0],
    ...
    AR.i.trackerInterface = {
        ...
        setOnDisabledTriggerActive: function(a) {
            AR.i.getBridgeObject(a.objectId)._onDisabledTriggerActive =
                a.onDisabledTriggerActive;
            AR.ADE.instance.alertModification(a.objectId)
        },
        setOnLoadedTriggerActive: function(a) {
            AR.i.getBridgeObject(a.objectId)._onLoadedTriggerActive = a
        ...
        explain: function() {
            return {
                ...
                properties: {
                    ...
                    maxDistance: AR.i.radarInterface._maxDistance < 0 ?
                        undefined : AR.i.radarInterface._maxDistance,
